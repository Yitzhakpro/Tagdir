...
export class EslintPlugin {
	...
	private readonly rules?: EslintRule;
	private readonly sharedConfigName?: string;
	private readonly configurationPackageName?: string;
	private readonly configurationPriority: number; // TODO: think of better solution
